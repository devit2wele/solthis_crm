...
class IMPORTENGAGEMENT(models.Model):
    ...
    engagement_line = fields.One2many('crm.alima.engagement.template', 'engagement_id', string='Engagement', required=True)
            ...
            for key in dicos[i]:
                ...
                if key == 'donateur' and dicos[i][key] :
                    try:
                        ...
                        dicos[i][key] = self.env['crm.alima.donateur'].search([('name', '=', dicos[i][key].strip())], limit=1)
