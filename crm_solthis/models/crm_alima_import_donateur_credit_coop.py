...
class IMPORTDONATEURCREDITCOOP(models.Model):
    ...
    separator = fields.Selection(SEPARATOR, default='point_virgule', required=True)
...
class DonateurTemplate(models.Model):
    ...
    partenaire=fields.Boolean(string="Partenaire", default=False)
    ...
    telemarketing = fields.Boolean(string='Télémarketing', default=False)
    email3 =fields.Boolean(string='Email', default=False)
    ...
    evenement =fields.Boolean(string='Evénement', default=False)
    option_CNIL =fields.Boolean(string='CNIL', default=False)
    echange_mail=fields.Boolean(string='Echange adresse email', default=False)
    ...
    id_bulletin = fields.Char()

    donateur_credit_coop_id = fields.Many2one('crm.alima.import.donateur.credit.coop', string='CREDIT COOP')
